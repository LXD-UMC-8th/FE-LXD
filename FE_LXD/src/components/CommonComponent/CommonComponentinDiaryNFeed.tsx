const CommonComponentInDiaryNFeed = () => {
  ...
  return (
    <div className="w-200 h-72 rounded-tl-[10px] rounded-tr-[10px] pt-8 pr-4 pb-8 pl-8 gap-3 shadow-[0px_4px_30px_0px_rgba(0,0,0,0.1)] bg-white">
      {/* 우측 상단 언어 + 더보기 아이콘 */}
      ...
      <div className="flex justify-between w-189 h-40 gap-10 mt-6">
        <div className="flex flex-col gap-4 w-141 h-25">
          ...
          <div className="text-body2 text-[#333333]">
            ...
            완벽하진 않은데, 일찍 자려는 의식이 생긴 것만으로도 괜찮은 변화
            같음. 아침에 일어나서 제일 먼저 물 한 잔 마시고 스트레칭. 그다음엔
            노트에 오늘 할 일 몇 개 써본다. 이거라도 안 하면 하루가 금방
            흐트러짐.
          </div>
          {/* 댓글수 + 좋아요 수 + 교정 수 */}
