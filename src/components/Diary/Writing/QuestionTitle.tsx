...
const QuestionTitle = ({ _titleName, onClick }: QuestionTitleProps) => {
  ...
  return (
    <div className="w-full flex items-center justify-between rounded-lg gap-5">
      ...
      <div>
        <button
          className="group w-30 mt-5 p-2 h-12 flex items-center justify-center gap-1 border border-gray-300 hover:border-gray-700 rounded-md text-gray-500 hover:bg-gray-200 hover:text-gray-900 transition cursor-pointer
