...
import type { CorrectionCommentGetRequestDTO, CorrectionCommentGetResponseDTO } from "../../../utils/types/correctionComment"
import { getCorrectionComments } from "../../../apis/correctionComment"

export const useGetCorrectionComments = () => {
    return useMutation<CorrectionCommentGetResponseDTO, Error, CorrectionCommentGetRequestDTO>({
